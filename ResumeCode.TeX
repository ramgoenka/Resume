...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \small{\item{
     \textbf{Relevant Coursework}{: Abstract Linear Algebra, Data Structures, Differential Equations, Number Theory}\\
     \textbf{Current Coursework}{: (Graduate) Stochastic Processes, Artificial Intelligence, Intro. to Abstract Algebra, Computational Mathematics, Machine Learning \& Computational Linguistics} \\
    }}
 \end{itemize}
